...
st.markdown(f'<aside class="wood-menu" aria-label="主要選單"><div class="wood-slot">QUEST</div><div class="wood-slot">SKILLS</div><div class="wood-slot">信仰&amp;真實</div><div class="wood-slot">角色日誌</div><div class="wood-slot">查看信箱</div></aside><div class="jp-shell"><div class="jp-inner"><div class="title-wrap"><div class="clock-panel" aria-label="目前時間，24 小時制"><span class="clock-time">{clock_text}</span></div><div class="title">角色狀態</div></div>', unsafe_allow_html=True)
