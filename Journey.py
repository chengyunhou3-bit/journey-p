...
st.markdown(
    """
    <style>
    @import url('https://fonts.googleapis.com/css2?family=Noto+Serif+TC:wght@500;700;900&family=Silkscreen:wght@400;700&display=swap');
    ...
    * { box-sizing:border-box; }
    ...
    .jp-shell { border:4px solid #6f4b21; outline:2px solid #1a1108; padding:10px; border-radius:7px;
      box-shadow:0 0 0 2px #d3a34e,0 0 0 7px #25180b,0 22px 65px #000; background:#0b0c0bd9; position:relative; }
    .clock-panel{position:absolute;z-index:7;right:17px;top:15px;width:116px;height:43px;display:grid;place-items:center;padding:4px 7px 3px;border:2px solid #8f682f;outline:2px solid #100d08;background:linear-gradient(#15243d,#09111f);box-shadow:inset 0 0 0 2px #283d58,inset 0 0 12px #000,0 3px 6px #000;clip-path:polygon(6px 0,calc(100% - 6px) 0,100% 6px,100% calc(100% - 6px),calc(100% - 6px) 100%,6px 100%,0 calc(100% - 6px),0 6px)}.clock-time{font:700 .9rem/1 'Silkscreen','Courier New',monospace;color:#f2d788;letter-spacing:.04em;text-shadow:0 0 5px #d49439,2px 2px #000;font-variant-numeric:tabular-nums}.clock-label{font:700 .46rem/1 'Silkscreen','Courier New',monospace;color:#7890aa;letter-spacing:.12em}
...
st.markdown(f'<aside class="wood-menu" aria-label="主要選單"><div class="wood-slot">QUEST</div><div class="wood-slot">SKILLS</div><div class="wood-slot">信仰&amp;真實</div><div class="wood-slot">角色日誌</div><div class="wood-slot">查看信箱</div></aside><div class="jp-shell"><div class="clock-panel" aria-label="目前時間，24 小時制"><span class="clock-time">{clock_text}</span><small class="clock-label">24H LOCAL</small></div><div class="jp-inner"><div class="title-wrap"><div class="title">角色狀態</div></div>', unsafe_allow_html=True)
